...
![darcs](/history/Darcs-logo.png) Автор: Изначально это изображение было загружено пользователем JohnyDog, а затем перенесено в Викихранилище пользователем IngerAlHaosului при помощи CommonsHelper., GPL, https://commons.wikimedia.org/w/index.php?curid=8988382
